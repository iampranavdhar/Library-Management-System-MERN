        ...
        <div className='dashboard'>
            <div className='dashboard-card'>
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <a href="#profile@member" className={`dashboard-option ${active === "profile" ? "clicked" : ""}`} onClick={() => { setActive("profile"); setSidebar(false) }}><AccountCircleIcon className='dashboard-option-icon' /> Profile</a>
                    <a href="#activebooks@member" className={`dashboard-option ${active === "active" ? "clicked" : ""}`} onClick={() => { setActive("active"); setSidebar(false) }}><LocalLibraryIcon className='dashboard-option-icon' /> Active</a>
                    <a href="#reservedbook@member" className={`dashboard-option ${active === "reserved" ? "clicked" : ""}`} onClick={() => { setActive("reserved"); setSidebar(false) }}><BookIcon className='dashboard-option-icon' /> Reserved</a>
                    <a href="#history@member" className={`dashboard-option ${active === "history" ? "clicked" : ""}`} onClick={() => { setActive("history"); setSidebar(false) }}><HistoryIcon className='dashboard-option-icon' /> History</a>
                    <a href="#profile@member" className={`dashboard-option ${active === "logout" ? "clicked" : ""}`} onClick={() => { logout(); setSidebar(false) }}><PowerSettingsNewIcon className='dashboard-option-icon' /> Log out </a>
                </div>
                        ...
                        <div className="user-details-specific">
                            ...
                            <div className="specific-right">
                                <div className="specific-right-top">
                                    <p className="specific-right-topic"><b>Points</b></p>
                                ...
                                <div className="specific-right-bottom">
                                    <p className="specific-right-topic"><b>Rank</b></p>
